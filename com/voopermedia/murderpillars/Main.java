...
public class Main extends JavaPlugin {
    ...
    public void MoveCaterpillars(){
        for (Caterpillar c : caterpillars){
            ...
            tail.getWorld().getBlockAt(tail).setType(Material.LAVA);
            Player closest = null;
            ...
            for (Player p : Bukkit.getOnlinePlayers()){
                ...
                Bukkit.getConsoleSender().sendMessage(head.toString());;
            ...
            if (bpl != null){
                ...
                newHead.getWorld().getBlockAt(newHead).setType(Material.END_PORTAL);
            }
        }
    }
